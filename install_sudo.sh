...
sudo apt install -y build-essential gcc g++ llvm clang lld cmake ninja-build git gdb autoconf automake libtool pkg-config libncurses-dev libssl-dev make python3-dev libdwarf-dev libdw-dev
